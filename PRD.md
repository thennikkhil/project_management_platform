...
- `POST /register` - User registration - working perfectly
- `POST /login` - User authentication - working perfectly
- `POST /logout` - User logout (secured) - 
- `GET /current-user` - Get current user info (secured) - working perfectly
